...
import com.jd.android.weatherapp.domain.commands.RequestDayForecastCommand
import com.jd.android.weatherapp.domain.model.Forecast
import com.jd.android.weatherapp.extensions.color
import com.jd.android.weatherapp.extensions.textColor
    ...
    private fun bindForecast(forecast: Forecast) =
        with(forecast) {
            ...
            supportActionBar?.subtitle =
                    date.toDateString(DateFormat.FULL)
